...
#The hard way: Import the entire folder into your IDE of choice (Eclipse definitely works, we can’t guarantee for anything else). 
The main class can be found in the main folder and is called driver.java. 
...
If your IDE supports mp3, feel free to uncomment the soundtrack (and check that the chibininja.mp3 file in src/uk/ac/ucl/robotisland/src/wav/ is also 
in bin/uk/ac/ucl/robotisland/src/wav.  In addition, you can turn on dev mode, giving you more infos on the robot. 
Have fun! Maybe you’ll even contribute to this repository?
